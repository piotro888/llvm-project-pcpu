...
static cl::opt<unsigned> SSThreshold(
    "PCPU-ssection-threshold", cl::Hidden,
...
// section.
bool PCPUTargetObjectFile::isGlobalInSmallSection(
...
// Return true if this global address should be placed into small data/bss
// section.
bool PCPUTargetObjectFile::isGlobalInSmallSection(const GlobalObject *GO,
                                                   const TargetMachine &TM,
...
// kind.
bool PCPUTargetObjectFile::isGlobalInSmallSectionImpl(
    const GlobalObject *GO, const TargetMachine &TM) const {
...
MCSection *PCPUTargetObjectFile::SelectSectionForGlobal(
...
bool PCPUTargetObjectFile::isConstantInSmallSection(const DataLayout &DL,
                                                     const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *PCPUTargetObjectFile::getSectionForConstant(
