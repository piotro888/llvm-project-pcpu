//= PCPUInstPrinter.h - Convert PCPU MCInst to asm syntax -------*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a PCPU MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_PCPU_MCTARGETDESC_PCPUINSTPRINTER_H
#define LLVM_LIB_TARGET_PCPU_MCTARGETDESC_PCPUINSTPRINTER_H
...
class PCPUInstPrinter : public MCInstPrinter {
public:
  PCPUInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
...
#endif // LLVM_LIB_TARGET_PCPU_MCTARGETDESC_PCPUINSTPRINTER_H
