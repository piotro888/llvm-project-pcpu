  ...
  if (PqShift != -1) {
    ...
    case 0x0:
      if (Instr.getOperand(2).isReg()) {
        Instr.getOperand(2).setReg(PCPU::R0);
      }
...
PCPUDisassembler::getInstruction(MCInst &Instr, uint64_t &Size,
  ...
  Result =
      decodeInstruction(DecoderTablePCPU32, Instr, Insn, Address, this, STI);
...
static const unsigned GPRDecoderTable[] = {
    PCPU::R0,  PCPU::R1,  PCPU::PC,  PCPU::R3,  PCPU::SP,  PCPU::FP,
    PCPU::R6,  PCPU::R7,  PCPU::RV,  PCPU::R9,  PCPU::RR1, PCPU::RR2,
    PCPU::R12, PCPU::R13, PCPU::R14, PCPU::RCA, PCPU::R16, PCPU::R17,
    PCPU::R18, PCPU::R19, PCPU::R20, PCPU::R21, PCPU::R22, PCPU::R23,
    PCPU::R24, PCPU::R25, PCPU::R26, PCPU::R27, PCPU::R28, PCPU::R29,
    PCPU::R30, PCPU::R31};
